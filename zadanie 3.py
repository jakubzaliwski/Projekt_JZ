...
# ponownie wyświetl je na ekranie. Nie korzystaj z z biblioteki numpy.
import random
import statistics
...
try:
    ...
    srednia = round(statistics.mean(lista))
    odchylenie_standardowe = round(statistics.stdev(lista))
    ...
    with open('zad3.txt', 'w') as plik:
        ...
        print("odchylenie standardowe wynosi: ", odchylenie_standardowe, file=plik )
